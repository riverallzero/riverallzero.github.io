...
## 1. GPT Assistant training pipeline
...
## 3. Two example models

### 3.1 어휘(vocabulary) 크기
...
## 4. Base models learn powerful, general representations
...
## 5. RM(Reward Modeling) & RL(Reinforcement Learning)
